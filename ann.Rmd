---
title: "Artificial Neural Network - Classification of Stars and Simple Stellar"
...
datasample  <- read_table2(datafile, col_names = c("filename", "F395-R","F410-R","F430-R","F515-R", 	"F660-R", "F861-R", "g-r", "i-r", "r-r", "u-r", "x-r"))
```
